...
# model_state_dict['out_blocks.4.scale_sum'] = torch.nn.Parameter(torch.tensor(0.6369))
# model_state_dict['out_blocks.4.scale_rbf_F'] = torch.nn.Parameter(torch.tensor(8.8912))
