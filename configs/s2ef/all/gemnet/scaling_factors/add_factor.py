...
# 步骤 1: 加载现有的模型状态字典
checkpoint_path =  "/home/liud/Documents/code/ocp/configs/s2ef/all/gemnet/scaling_factors/fit_scale/gemnet_all_128b_energy_tags12.pt"  # 替换为你的 .pt 文件路径
...
# #
# # # 步骤 3: 保存更新后的状态字典
# new_checkpoint_path = '/home/liud/Documents/code/ocp/configs/s2ef/all/gemnet/scaling_factors/gemnet-oc-new.pt'  # 替换为新的 .pt 文件路径
# torch.save({}, new_checkpoint_path)
# # #
