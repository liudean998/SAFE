...
class InteractionBlock(torch.nn.Module):
    ...
    def __init__(
        ...
        if atom_interaction:
            ...
            # self.atom_interaction_input_graph = PairInteraction(
            #     emb_size_atom=emb_size_atom,
            #     emb_size_pair_in=emb_size_a2a_in,
            #     emb_size_pair_out=emb_size_a2a_out,
            #     emb_size_rbf=emb_size_rbf,
        ...
        # num_aint = 1.0 + edge_atom_interaction + 2*atom_interaction # 修改
    ...
    def forward(
        ...
        if self.atom_interaction is not None:
            ...
            # if basis_a2a_rad_ads is not None:
            #     h_a2a_ads = self.atom_interaction_input_graph(
            #         h,
            #         basis_a2a_rad_ads,
            #         with_ads_graph['edge_index'],
            #         with_ads_graph['target_neighbor_idx']
            #     )
        ...
        if self.atom_interaction is not None:
            # h = h + h_a2a + h_a2a_ads  # (nEdges, emb_size_edge)
