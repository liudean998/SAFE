...
def radius_graph_pbc_unique_edges(
    data,
    radius,
    max_num_neighbors_threshold,
    enforce_max_neighbors_strictly: bool = False,
    ...
    edge_index_unique, inverse_indices = torch.unique(edge_index, dim=1, return_inverse=True)
    atom_distance_sqr_unique = atom_distance_sqr[inverse_indices]
...
def get_max_neighbors_mask(
    ...
    # print(mask_num_neighbors.tolist())
    return mask_num_neighbors, num_neighbors_image
